    ...
    <div className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          >
            <img
              src="https://res.cloudinary.com/dz81bjuea/image/upload/v1747031052/founder_vpnyov.jpg"
        ...
        >
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 auto-rows-fr justify-items-center">
