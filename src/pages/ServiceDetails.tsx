        ...
        >
          <div className="p-4 md:p-8">
            <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6">
              <div className="w-12 h-12 md:w-16 md:h-16 bg-[#FFF5F2] rounded-xl flex items-center justify-center">
                {IconComponent && <IconComponent className="w-6 h-6 md:w-8 md:h-8 text-[#FF5733]" />}
              </div>
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900">{serviceCategory.name}</h1>
                <p className="text-sm md:text-base text-gray-600 mt-1">{serviceCategory.description}</p>
              </div>
            </div>
                    ...
                    >
                      <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-4">
                        <div className="w-full md:w-3/5">
                          ...
                          <p className="text-xs md:text-sm text-gray-500 mt-2 mb-3">
                            Recommended: {service.recommended}
                          </p>

                          <div className="grid gap-2">
                            {service.features.map((feature) => (
                              <div key={feature.id} className="flex items-center text-sm md:text-base text-gray-700">
                                <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-green-500 mr-2 flex-shrink-0" />
                        ...
                        <div className="w-full md:w-2/5">
                          <div className="flex flex-col items-center md:items-end">
                            {!selectedVehicle ? (
                              <div className="text-sm text-[#FF5733] font-medium text-center md:text-right">
                                <div className="w-full h-48 md:w-64 md:h-64 rounded-2xl overflow-hidden bg-white mb-2 border-2 border-gray-100 shadow-sm hover:border-[#FF5733]/20 transition-colors">
                                  <img 
                              ...
                              <div className="flex flex-col items-center md:items-end">
                                {isPriceLoading ? (
                                  ...
                                  <div className="flex flex-col items-center md:items-end">
                                    <div className="flex flex-col md:flex-row items-center text-lg font-semibold text-gray-900">
                                      ...
                                      <span className="text-xs text-gray-500 font-normal mt-1 md:mt-0 md:ml-2">
                                        {priceData?.is_custom_price ? 'Special price for' : 'Standard price for'} {selectedVehicle.manufacturer} {selectedVehicle.model}
                                      </span>
                                    </div>
                      ...
                      <div className="mt-6 md:mt-8">
                        {!selectedVehicle ? (
                          <div className="bg-gray-50 rounded-lg p-4 flex flex-col md:flex-row items-center justify-center gap-3">
                            <p className="text-sm md:text-base text-gray-600 font-medium text-center">👆 Please select your vehicle to proceed</p>
                            <VehicleSelectButton 
                          ...
                          <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-gray-50 rounded-lg p-4">
                            <VehicleSelectButton 
