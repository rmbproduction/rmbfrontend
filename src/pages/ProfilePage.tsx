            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 space-y-6">
              <div className="text-center">
                <div className="h-24 w-24 rounded-full bg-[#FFF5F2] flex items-center justify-center mx-auto overflow-hidden">
                  {profile && (previewUrl || safeProfile.profile_photo) ? (
                    <img
                      src={
                        previewUrl || getProfilePhotoUrl(safeProfile.profile_photo)
                      }
                      alt="Profile"
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-6">
                    <div className="relative">
                      ...
                      >
                        {(previewUrl || safeProfile.profile_photo) ? (
                          <img
                            src={previewUrl || getProfilePhotoUrl(safeProfile.profile_photo)}
                            alt="Profile"
                            className="h-full w-full object-cover"
                            onError={(e) => {
