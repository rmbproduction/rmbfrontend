...
const SubscriptionPlans: React.FC = () => {
  ...
  const handleSubscribe = (planId: number, variantId: number) => {
    if (!isAuthenticated) {
      navigate('/login', { state: { from: '/pricing' } });
      return;
    }
    // TODO: Implement subscription logic
    console.log('Subscribe to plan:', planId, 'variant:', variantId);
  };
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-2 text-xs text-gray-500">
                    Up to {variant.max_visits} visits included
                  </div>
                  <button 
                    onClick={() => handleSubscribe(plan.id, variant.id)}
